            ...
            <div className="flex">
                ...
                <div className="w-1/2 p-8">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-4">
        <label htmlFor="contenu" className="block text-sm font-medium text-gray-600">
Contenu        </label>
        <textarea
          id="additionalInfo"
          className="mt-1 p-2 border rounded w-full max-w-full max-h-[120px]"
          rows="4"
        ...
        ></textarea>
                ...
                <div className="w-1/2 flex justify-end">
                    <img src="/images/partenaire.png" alt="Devis" className="w-99 h-auto ml-auto " />
                </div>
            </div>
        </div>
    );
