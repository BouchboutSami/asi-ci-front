...
const Partners = () => {
  return (
    <div className="flex flex-col gap-10 w-full items-center relative">
      <h1 className="text-4xl text-darkblue font-semibold">Nos partenaires</h1>
      ...
      <button
        ...
        onClick={() => {
          console.log("Go to partenaire form");
        }}
      >
        <p className="font-montserrat font-medium">Devenir partenaire</p>
        <LiaHandshakeSolid />
      </button>
    </div>
  );
