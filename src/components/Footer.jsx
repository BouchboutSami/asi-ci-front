...
const Footer = () => {
  return (
    <footer className="text-center bg-blue text-white border-t-4 justify-self-end flex">
      <div className="pt-6">
        <div className="flex justify-center items-center mb-6">
          ...
          <a
            target="_blank"
            rel="noopener noreferrer"
            href="https://www.linkedin.com/school/ecole-superieure-informatique-alger"
            type="button"
            className="rounded-full border-2 border-IGLorange text-white leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1"
          >
            <svg
          ...
          <a
            target="_blank"
            rel="noopener noreferrer"
            href="https://github.com/BouchboutSami/"
            type="button"
            className="rounded-full border-2 border-IGLorange text-white leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1"
          >
            <svg
        ...
        <div className="mb-6">
          <p className="px-[10%]">
            ...
            distinctio, iste molestias reprehenderit ipsam blanditiis nisi
            dolorem quibusdam omnis ullam repellendus beatae, ex ipsa nobis
            rerum, in officia. Eligendi sed iure vel nam rerum dignissimos sint
            esse assumenda voluptatibus facere.
          </p>
        </div>
            ...
            <ul className="list-none mb-0">
              <li>
                <a href="#!" className="text-white">
                  Dahak Fouad : f_dahak@esi.dz
                </a>
              </li>
              <li>
                <a href="#!" className="text-white">
                  Guerroumi Djazia : d_guerroumi@esi.dz
                </a>
              </li>
            </ul>
          </div>
